...
const DeliveryManRegisterScreen = () => {
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          ...
          >
            <View style={styles.header}>
              <Text style={styles.headerTitle}>Register as Delivery Man</Text>
              <Text style={styles.headerSubtitle}>
                Join us and deliver with ease
              </Text>
            </View>
...
export default DeliveryManRegisterScreen;
